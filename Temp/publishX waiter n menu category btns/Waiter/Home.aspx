    ...
    <script>
        function PlaceOrder(theID) {
            if (document.getElementById('CPHBody_ddlPlaces').value == 0) {
                ...
                return false;
            } else if (document.getElementById('CPHBody_ddlFoods').value == 0) {
                alertMe('error', 'Please Select Food', 'center', 3000);
                return false;
            } else  {
        ...
        function getFoodsOfCategory(val) {
            var requestManager = Sys.WebForms.PageRequestManager.getInstance();
            function EndRequestHandler(sender, args) {
                requestManager.remove_endRequest(EndRequestHandler);
            }
            requestManager.add_endRequest(EndRequestHandler);
            __doPostBack('<%=upd_Cat.UniqueID %>', 'updateFoodList_' + val);
        }
            ...
            <div class="col-xl-11">
                ...
                <div class="row align-items-center mt-3 mb-4">
                    ...
                    <div style="width: 100%;">
                        ...
                        <asp:UpdatePanel runat="server" ID="upd_Cat" UpdateMode="Conditional" ChildrenAsTriggers="true">
                            <ContentTemplate>
                                <label class="mt-2">Select Category</label>
                                <asp:Panel runat="server" ID="pnl_Cat"></asp:Panel>
                            ...
                            <div class="col-12 ddlstyle">
                                ...
                                <asp:DropDownList runat="server" ID="ddlFoods" CssClass="form-control" data-live-search="true" DataTextField="Name" DataValueField="Id">
                                </asp:DropDownList>
                            </div>
                        </div>
                        ...
                        <div class="col-12 text-center mt-3">
                            <a class='btn btn-gradient-02 btclr' data-toggle='modal' data-target='#MoOrderDetail' onclick="PlaceOrder(this)" style="width: 100%;">Select</a>
                        </div>
