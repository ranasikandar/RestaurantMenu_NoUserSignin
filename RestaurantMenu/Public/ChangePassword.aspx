<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="RestaurantMenu.Public.ChangePassword" %>
...
<head runat="server">
    ...
    <title><% Response.Write(System.Configuration.ConfigurationManager.AppSettings["BusinessNicName"].ToString());%> | Change Password</title>
...
<body class="elisyam-overlay overlay-04">
    <!-- Begin Preloader -->
    <div id="preloader">
        <div class="canvas">
                ...
                <form id="form1" runat="server">
                    ...
                    <script type="text/javascript">
                        ...
                        function EndRequestHandler(sender, args) {
                            ...
                            var el = document.getElementById("btnChangePass");
                            el.disabled = false;
                            el.value = 'Change My Password';
                        }
                    </script>
                            ...
                            <ContentTemplate>
                                ...
                                <form>
                                    <div class="group material-input">
                                        <asp:TextBox ID="txtCurrentPassword" runat="server" TextMode="Password" required></asp:TextBox>
                                ...
                                <div class="button text-center">
                                    <asp:Button ID="btnChangePass" class="btn btn-lg btn-gradient-02" runat="server" OnClientClick="this.disabled = true; this.value = 'Please Wait...';" OnClick="btnChangePass_Click" Text="Change Password" UseSubmitBehavior="false" />
                                </div>
