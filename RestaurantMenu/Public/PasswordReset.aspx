<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PasswordReset.aspx.cs" Inherits="RestaurantMenu.Public.PasswordReset" %>
...
<head runat="server">
    ...
    <title><% Response.Write(System.Configuration.ConfigurationManager.AppSettings["BusinessNicName"].ToString());%> | Password Reset</title>
                ...
                <form id="form1" runat="server">
                    ...
                    <script type="text/javascript">
                        ...
                        function EndRequestHandler(sender, args) {
                            ...
                            if (args.get_error()) {
                                alertMe('error', 'Sorry we are unable to Proceed your request. Please try again', 'center', 10000);
                                console.log(args.get_error().description);
                                args.set_errorHandled(true);
                            }

                            var el = document.getElementById("btnSetNewPass");
                            el.disabled = false;
                            el.value = 'Set My New Password';
                        }
                    </script>
                        ...
                        <asp:UpdatePanel ID="updSignup" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                            <ContentTemplate>
                                ...
                                <div class="button text-center">
                                    <asp:Button ID="btnSetNewPass" class="btn btn-lg btn-gradient-02" runat="server" OnClientClick="this.disabled = true; this.value = 'Please Wait...';" OnClick="btnSetNewPass_Click" Text="Set New Password" UseSubmitBehavior="false" />
                                </div>
