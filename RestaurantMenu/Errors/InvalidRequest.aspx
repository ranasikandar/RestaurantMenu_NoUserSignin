<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvalidRequest.aspx.cs" Inherits="RestaurantMenu.Errors.InvalidRequest" %>
...
<head runat="server">
    ...
    <title><% Response.Write(System.Configuration.ConfigurationManager.AppSettings["BusinessName"].ToString());%> | Invalid Request</title>
        ...
        <div class="row justify-content-center align-items-center h-100">
            ...
            <div class="col-xl-4 col-lg-4 col-md-8 no-padding d-flex justify-content-center">
                ...
                <div class="error-02 mx-auto mb-3 text-center">
                    <h1 class="text-gradient-01">Sorry</h1>
                    <h2>its an invalid request</h2>
                </div>
                <!-- End Error -->
            </div>
            <!-- End Left Content -->
